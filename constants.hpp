...
//Название движка
const std::string engine_name = "Zevra v1.8.6 r672";
...
//Пешки
const Score pawnPST[BOARD_SIZE][BOARD_SIZE / 2] = {
{S(0, 0), S(0, 0), S(0, 0), S(0, 0)},
{S(50, 65), S(50, 66), S(50, 67), S(50, 68)},
{S(10, 55), S(10, 56), S(20, 57), S(30, 58)},
{S(5, 45), S(5, 46), S(10, 47), S(25, 48)},
{S(0, 30), S(0, 31), S(0, 32), S(20, 33)},
{S(5, 25), S(-5, 26), S(-10, 27), S(0, 28)},
{S(5, 20), S(10, 21), S(10, 22), S(-20, 23)},
{S(0, 0), S(0, 0), S(0, 0), S(0, 0)}
};
